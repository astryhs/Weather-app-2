import { capitalizeCity } from "../helpers/capitalizedCity.js";
...
export const renderCurrentWeather = (data, city) => {
  currentCity.textContent = capitalizeCity(city || "Неизвестно");
  ...
  currentWeatherIcon.src =
    `https://openweathermap.org/img/wn/${data.weather?.[0]?.icon}.png` || "01d";
